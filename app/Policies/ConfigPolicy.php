...
class ConfigPolicy
{
    ...
    {
        return $user->hasPermissionTo('view_any_config');
    }
    ...
    /**
     * Determine whether user can view data of config
     *
     */
    public function readData(User $user, Config $config): bool
    {
        return $config->public || $this->viewAny($user);
    }
    ...
    {
        return $user->hasPermissionTo('update_config');
    }
